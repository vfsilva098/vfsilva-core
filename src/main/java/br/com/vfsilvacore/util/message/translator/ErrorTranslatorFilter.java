...
@Component(value = "translatorFilter")
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class ErrorTranslatorFilter implements IErrorTranslator {
    ...
    public void translateErrorMessage(ErrorMessage errorMessage, Locale locale) {
        ...
        I18nMessage messageTile = internationalizeTerm(errorMessage.getTitle(), locale);

        String title = messageTile != null ? messageTile.getMessage() : null;
        I18nMessage i18nMessage = internationalizeTerm((errorMessage.getError()), locale);
